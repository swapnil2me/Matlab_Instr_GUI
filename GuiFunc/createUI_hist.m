...
S.mixF  = uicontrol('Style', 'edit','Units','normalized','Position',[0.1,0.3,0.1,0.095],'String',pastConf.mixF);
...
S.VgDCInstAdr  = uicontrol('Style', 'edit','Units','normalized','Position',[0.7,0.7,0.25,0.095],'String',pastConf.IpS{1});
S.VgACInstAdr  = uicontrol('Style', 'edit','Units','normalized','Position',[0.7,0.6,0.25,0.095],'String',pastConf.IpS{2});
S.VsACInstAdr  = uicontrol('Style', 'edit','Units','normalized','Position',[0.7,0.5,0.25,0.095],'String',pastConf.IpS{3});
S.LIAInstAdr      = uicontrol('Style', 'edit','Units','normalized','Position',[0.7,0.4,0.25,0.095],'String',pastConf.IpS{4});
